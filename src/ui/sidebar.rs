...
pub(crate) struct AgentPanelEntry {
    ...
    /// Orthogonal live input-prompt presence. Agent-view filters and sorts read
    /// these; the same fields travel to the client shell on
    /// `ClientShellAgent`, which renders the "input waiting · <kind>" status in
    /// the agent sidebar and the mobile switcher.
