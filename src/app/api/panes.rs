...
use crate::api::schema::{
    ...
    PaneSendTextParams, PaneSetPtySizeParams, PaneSplitParams, PaneSwapParams, PaneSwapReason,
    PaneSwapResult, PaneTarget, PaneTextPoint, PaneTextRange, PaneTurnRecord, PaneTurnsParams,
    PaneTurnsResult, PaneZoomMode, PaneZoomParams, PaneZoomReason, PaneZoomResult, ResponseResult,
};
